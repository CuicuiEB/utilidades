...
// @version      1.1.14
// @description  Bot para encontrar cuervos
// @author       Cuicui
// @match        https://marketplace.plantvsundead.com/*
// @icon         https://plantvsundead.com/assets/img/icon.svg
// @updateURL    https://raw.githubusercontent.com/CuicuiEB/helpbot/main/CrowBot.js
                    ...
                    if (capthaDialog.length === 0) {
                        ...
                        if (curPage == maxPage) {
                            if (validCount > 0) {
                                ...
                                console.log("Cuervo encontrado!");
                            }

                            lastPageToast.showToast();
                            console.log("Ultima pagina encontrada");
